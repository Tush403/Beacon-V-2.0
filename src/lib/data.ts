...
export const mockToolsData: Tool[] = [
  ...
  },
  {
    ...
    "score": 9.2,
    "logoUrl": "/Logo/ZeTA Automation.png",
  ...
  },
  {
    ...
    "name": "RelicX",
    "score": 9.0,
    "logoUrl": "/Logo/RelicX.png",
    "dataAiHint": "RelicX logo",
    "applicationTypes": ["Web"],
    ...
    "reportingAnalytics": ["Basic", "Integration-friendly"],
    "strengths": [
      "Low-Code Simplicity: Allows rapid test creation without extensive coding",
      "Integrated Dashboard: Centralized analytics and test management",
      "Cross-Platform Support: Works across Windows, macOS, and Linux",
      //"Easy Maintenance: Visual workflows simplify updates"
    ],
    "weaknesses": [
      "Commercial Licensing: Higher cost compared to open-source tools",
      "Limited Customization: Less flexibility for complex custom scripting",
      "Scalability Constraints: May face challenges in large-scale CI/CD pipelines"
    ],
    "pdfLink": "/pdfs/RelicX-guide.pdf",
    "websiteUrl": "https://RelicX-testing.com",
    "roiProjection": [
      { "month": 1, "roi": 50 },
      { "month": 2, "roi": 60 },
      { "month": 3, "roi": 70 },
    ...
    "maintenanceOverhead": "Low – Visual workflows reduce effort",
    "testCreationSpeed": "Very High – Low-code builder speeds up scripting",
    "scriptReusability": "Medium – Reusable components with drag-and-drop logic",
    "parallelExecutionSupport": "Good – Supports limited parallelism depending on license",
    "testCaseCreationEffort": "Low – Drag-and-drop interface minimizes manual work",
    "skillRequirement": "Low – Minimal coding knowledge required",
    "overallAutomationCoverage": "High – Efficient for UI and API validations",
    "totalCostOfOwnership": "Medium to High – Licensing and support costs apply"
  },  
  {
    id: "22",
    name: "Playwright",
    score: 9.0,
    logoUrl: "/Logo/Playwright.svg",
  ...
  },
  {
    ...
    name: "JMeter",
    score: 8.3,
    logoUrl: "/Logo/Apache JMeter.svg",
  ...
  },
  {
    ...
    name: "Katalon Studio",
    score: 8.6,
    logoUrl: "/Logo/Katalon Studio.png",
  ...
  },
  {
    ...
    score: 8.4,
    logoUrl: "/Logo/Robot Framework.png",
  ...
  },
  {
    ...
    codingLanguages: ["N/A"],
    pricingModels: ["Subscription"],
    reportingAnalytics: ["Real-time", "Advanced"], // Example, adjust as needed
    strengths: [
  ...
  },
  {
    ...
    score: 8.0,
    logoUrl: "/Logo/LoadRunner Enterprise.png",
